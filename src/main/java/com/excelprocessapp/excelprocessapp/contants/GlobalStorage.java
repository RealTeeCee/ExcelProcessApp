package com.excelprocessapp.excelprocessapp.contants;
...
public interface GlobalStorage {
    // import static com.excelprocessapp.excelprocessapp.contants.GlobalStorage.*;
    ...
    // Excel
    public final int COL_BANK_DATE = 0;
    public final int COL_BANK_REF = 1;
    public final int COL_DESCRIPTION = 2;
    public final int COL_CREDIT = 3;
